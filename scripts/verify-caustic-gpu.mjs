...
import { CAUSTIC_SIZE, RAY_STRIDE, RAYS_PER_SOURCE } from '../src/graphics/optics/caustic-kernels.js';
...
if(!runtime||!existsSync(runtime)){
  ...
  let raisedHits=0;for(let i=0;i<RAYS_PER_SOURCE;i++)if(elevated[i*20+7]===2)raisedHits++;
